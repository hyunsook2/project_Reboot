...
public class AccountBoardDAO extends JDBConnPool{
	...
	public int updatePost(AccountBoardDTO dto) {
		
//		int result=0;
//		String query="insert into info(deptn,id,name,grade,in_d,off_d,pass,out_d,bday,pnum,ad)"
//				+ "values(?,?,?,?,?,?,?,?,?,?,?)";
//		try {
//			psmt = con.prepareStatement(query);
...
//	        psmt.setDate(8, new java.sql.Date(dto.getOut_d().getTime()));
//	        psmt.setDate(9, new java.sql.Date(dto.getBday().getTime()));
//	        psmt.setString(10, dto.getPnum());
//	        psmt.setString(11, dto.getAd());
//	        
//	        result = psmt.executeUpdate();
//	        
//	    } catch (Exception e) {
...
//	    return result;
		...
		try {
		    ...
		    psmt.setDate(4, new java.sql.Date(dto.getIn_d().getTime()));
		    psmt.setString(5, dto.getOff_d());
		    psmt.setString(6, dto.getPass());
		    psmt.setDate(7, new java.sql.Date(dto.getOut_d().getTime()));
		    psmt.setDate(8, new java.sql.Date(dto.getBday().getTime()));
