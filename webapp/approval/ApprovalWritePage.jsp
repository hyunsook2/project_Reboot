...
<body>
   ...
   <div class="sidebar2">
        <ul>
          ...
          <li><a href="../approval/approvalDoPage.do" class="menu-item">결재할 문서함</a></li>
          <li><a href="../approval/approvalOkPage.do" class="menu-item">결재완료료 문서함</a></li>
   ...
   <!-- 로그인정보 -->
     ...
     <!-- 가운데 -->
     <div class="board">
     	<form enctype="multipart/form-data" method="post" action="../approval/ApprovalWrite.do"><br><br>
		기안서 올릴놈
		...
		반려내용
		<textarea rows="5" cols="50" name="companion" readonly ></textarea><br><br>
