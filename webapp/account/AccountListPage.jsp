...
<body>
	<div class="sidebar">
		<ul>
			<li><a href="../rebootServlet/myPage.do"> <img
					src="http://localhost:8081/reboot/Reboot/img/user.png" alt="메뉴 1">
					<span style="font-size: 9pt;">프로필</span>
			</a></li>
			<li><a href="../JOTP/otp.do"> <img
					src="http://localhost:8081/reboot/Reboot/img/Attendance.png"
					alt="메뉴 2"> <span style="font-size: 3pt;">근태기록</span>
			</a></li>
			<li><a href="#" onclick="handleSidebar1click(2)"> <img
					src="http://localhost:8081/reboot/Reboot/img/Approval.png"
					alt="메뉴 3"> <span style="font-size: 3pt;">전자결재</span>
			</a></li>
			<li><a href="#"> <img
					src="http://localhost:8081/reboot/Reboot/img/organization.png"
					alt="메뉴 4"> <span style="font-size: 9pt;">조직도</span>
			</a></li>
			...
			<li><a href="../rebootServlet/logout.do"> <img
					src="http://localhost:8081/reboot/Reboot/img/logout.png" alt="메뉴 5">
	...
	<div class="center-header">
		<h2>
			<a href="#" onclick="handleSidebar1click(4)">계정 관리</a>
		</h2>
	</div>
...
<c:choose>
	<c:when test="${empty boardList}">
		<tr>
			<td colspan="4" align="center">생셩된 계정이 없습니다.</td>
		</tr>
	</c:when>
	<c:otherwise>
		<c:forEach items="${boardList}" var="list" varStatus="stat">
		<tr align="center">
			<td><c:choose><c:when test="${list.deptn == 0}">시스템팀</c:when><c:when test="${list.deptn == 1}">인사팀</c:when><c:when test="${list.deptn == 2}">업무팀</c:when><c:otherwise>부서명: 알 수 없는 부서</c:otherwise></c:choose></td>
			<td>${list.id}</td>
			<td>${list.name}</td>
